...
XX = 'STAINING_NEWDYES_ZYMOLYASE_XXX' # Needs to be changed at the start of a new experiment, specifying the dyes used and the date of experiment
refpos = 1
...
wells = ['A1','A2','A3','A4','A5','A6','A7','A8','A9','A10','A11','A12','B12','B11','B10','B9','B8','B7','B6','B5','B4','B3','B2','B1',
         'C1','C2','C3','C4','C5','C6','C7','C8','C9','C10','C11','C12','D12','D11','D10','D9','D8','D7','D6','D5','D4','D3','D2','D1'] #wells filled with sample
dilution = '1000' # Set the dilution applied to samples
sample1 = 'SK1'
sample2 = 'SK1'
samples = 'SK1'
brightfield = 'TL10'
light_source1 = 'NpHy4UV'
...
def photo_loop_pos(well_name):
    ...
    # Wait -> number of seconds to wait until the next picture.
        try:
            ...
            time.sleep(wait)
            hardwaresetting1 = ZenHardwareSetting()
            hardwaresetting1.SetParameter('MTBLED1', 'IsEnabled', 'true')
            ...
            hardwaresetting1 = ZenHardwareSetting()
            hardwaresetting1.SetParameter('MTBLED1', 'IsEnabled', 'false')
            Zen.Devices.ApplyHardwareSetting(hardwaresetting1)
            time.sleep(wait)
            hardwaresetting1 = ZenHardwareSetting()
...
Zen.Application.Pause("Light sources (B/UV): 30/100 and TL: 10. Set up directly in the microscope before starting the experiment!")
