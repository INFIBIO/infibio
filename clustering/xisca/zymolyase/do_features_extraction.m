...
%XF: startup.m to initialize Python environment in Matlab (if necessary).

%HISTORY: 
%   5 April, 2024: MP. Created.
%   4 July, 2024: AR. Modified.
%   11 July, 2024: XF. Modified.
%
%TODO:
...
imgpath = 'C:\Users\uib\Desktop\NN_training\classification\data\'; % INPUT: raw images path.
datapath = [imgpath,'data/']; % output path.
