...
myFolder = ['C:\Users\uib\Desktop\clustering\Exps_clustering_100rpm_200500_07222024_2\500' ];
...
for k = 1 : length(theFiles)
    ...
    image_analysis_agg_AR_V2(fullFileName, myFolder, python_path, yolo_path, predict_script, weights);  % CHANGE THE FUNCTION DEPENDING IF YOU'RE ANALYSING CLUSTERS OR ZYMOLIASE IMAGES
