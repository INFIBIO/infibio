function image_analysis_agg_AR_V2(route, myFolder, python_path, yolo_path, predict_script, weights)
...
X = croppedImage;
BW = imbinarize(im2gray(X), 'adaptive', 'Sensitivity', 0.30, 'ForegroundPolarity', 'bright');
...
BW_out = bwpropfilt(BW,'Area',[800 + eps(800), Inf]);
